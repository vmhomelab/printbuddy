export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      scanSubnetMoonraker: 'Escanear subred en busca de Moonraker',
      discoverNetwork: 'Detectar impresoras en la red',
      scanningSubnet: 'Escaneando la subred en busca de impresoras Bambu...',
      scanningSubnetMoonraker: 'Escaneando la subred en busca de impresoras Moonraker...',
      scanningNetwork: 'Escaneando la red...',
      noPrintersFoundSubnetMoonraker: 'No se encontraron instancias de Moonraker en la subred especificada.',
      moonrakerNeedsAuth: 'Esta instancia de Moonraker requiere un token API — introdúzcalo abajo.',
      moonrakerSubnetNote: 'Busca la API Moonraker/Klipper en los puertos de abajo (por defecto 7125 y luego 80 para CosmOS/Fluidd). Usa la misma lista de subredes que Bambu, incluido DISCOVERY_EXTRA_SUBNETS.',
      moonrakerPorts: 'Puertos a escanear',
      moonrakerPortsNote: 'Separados por comas. Use 80 para CosmOS / Moonraker con proxy. Solo se listan hosts con JSON de API Moonraker.',
  ...
  profiles: {
    ...
    tabs: {
      ...
      openFilamentDatabase: 'API de Open Filament Database',
    },
    localProfiles: {
    ...
    openFilamentDatabase: {
      title: 'API de Open Filament Database',
      subtitle: 'Elige si PrintBuddy debe buscar datos de filamento mediante Open Filament Database.',
      enableLabel: 'Buscar bobinas mediante Open Filament Database',
      enableDescription: 'Activa esta opción para buscar datos de filamento en Open Filament Database al crear bobinas locales de inventario.',
      failedToLoad: 'No se pudieron cargar los ajustes de Open Filament Database',
      noPermission: 'No tienes permiso para actualizar este ajuste.',
      toast: {
        updated: 'Ajuste de Open Filament Database actualizado',
      },
    },
  ...
  fileManager: {
    ...
    sourceArchive: 'Detalles archivados de MakerWorld',
    sourceArchiveLoadError: 'No se pudieron cargar los detalles de origen archivados.',
    sourceCapturedAt: 'Archivado el {{date}}',
    gridView: 'Vista de cuadrícula',
    listView: 'Vista de lista',
    lowDiskSpaceWarning: 'Advertencia de poco espacio en disco',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      searchToggle: 'Buscar mediante Open Filament Database',
      searchHint: 'Busca primero marcas de OFDB y luego selecciona material, filamento, variante y tamaño para rellenar esta bobina local.',
      brandLabel: 'Marca OFDB',
      brandPlaceholder: 'Buscar marcas OFDB...',
      materialLabel: 'Material OFDB',
      filamentLabel: 'Filamento OFDB',
      loadingBrands: 'Cargando marcas OFDB...',
      brandLoadFailed: 'No se pudieron cargar las marcas OFDB',
      materialLoadFailed: 'No se pudieron cargar los materiales OFDB para esta marca',
      noBrands: 'No se encontraron marcas OFDB.',
      noMaterials: 'Esta marca OFDB no tiene materiales para seleccionar.',
      searchPlaceholder: 'Buscar filamentos para la marca/material seleccionados...',
      brandMaterialHint: 'Selecciona una marca y un material OFDB antes de buscar filamentos.',
      missingBrandMaterial: 'Se requieren una marca y un material OFDB antes de buscar filamentos.',
      searchFailed: 'Falló la búsqueda en Open Filament Database',
      filamentLoadFailed: 'No se pudieron cargar los detalles del filamento OFDB',
      variantLoadFailed: 'No se pudieron cargar los detalles de la variante OFDB',
      noFilaments: 'No se encontraron filamentos OFDB para esta marca/material.',
      noVariants: 'Este filamento OFDB no tiene variantes para seleccionar.',
      filamentResults: 'Filamentos',
      variantResults: 'Variantes / colores',
      materialCount: '{{count}} material(es)',
      filamentCount: '{{count}} filamento(s)',
      variantCount: '{{count}} variante(s)',
      sizeCount: '{{count}} tamaño(s)',
    },
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notificaciones push mediante la app Notify',
    },
    ...
    noPrintersAvailable: 'No hay impresoras disponibles',
    onlyFromSelectedPrinters: 'Enviar notificaciones solo para eventos de las impresoras seleccionadas',
    fromAllPrinters: 'Enviar notificaciones para eventos de todas las impresoras',
    selectAtLeastOnePrinter: 'Selecciona al menos una impresora o elige Todas las impresoras.',
  ...
  makerworld: {
    ...
    archiveDetails: 'Archivar detalles de MakerWorld',
    archiveDetailsDescription: 'Guardar localmente la descripción y la imagen de portada con el archivo importado.',
    importDefaults: 'Valores predeterminados de importación',
    importDefaultsDescription: 'Aplica estas opciones automáticamente a las nuevas importaciones de MakerWorld. Puedes anularlas para cada importación.',
    archiveDetailsByDefault: 'Archivar detalles de MakerWorld de forma predeterminada',
    archiveDetailsByDefaultDescription: 'Guarda localmente la descripción, las instrucciones y las imágenes del modelo.',
    useCoverAsThumbnailByDefault: 'Usar la portada archivada como miniatura de biblioteca de forma predeterminada',
    useCoverAsThumbnailByDefaultDescription: 'También activa el archivado de detalles, ya que la miniatura usa la portada local archivada.',
    importDefaultsSaved: 'Valores predeterminados de importación de MakerWorld guardados.',
    importDefaultsSaveFailed: 'No se pudieron guardar los valores predeterminados de MakerWorld.',
    archiveDetailsDefaultControl: 'Archivo de origen predeterminado',
    coverThumbnailDefaultControl: 'Miniatura de portada predeterminada de biblioteca',
    useCoverAsThumbnail: 'Usar la portada de MakerWorld como miniatura de biblioteca',
    useCoverAsThumbnailDescription: 'Usa la imagen de portada de MakerWorld archivada localmente como miniatura de biblioteca para este archivo.',
    archivePartialWarning: 'El modelo se guardó, pero algunas imágenes de MakerWorld no pudieron archivarse.',
    archiveFailedWarning: 'El modelo se guardó, pero sus detalles de MakerWorld no pudieron archivarse.',
