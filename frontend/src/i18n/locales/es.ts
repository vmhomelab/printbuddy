export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      moonrakerSubnetNote: 'Busca Moonraker solo en el puerto 7125 (requiere JSON de API Moonraker/Klipper). Usa la misma lista de subredes que Bambu, incluido DISCOVERY_EXTRA_SUBNETS.',
