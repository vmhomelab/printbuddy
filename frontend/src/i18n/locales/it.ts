export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      customSubnet: 'CIDR personalizzato…',
      useDetectedSubnet: 'Usa sottorete rilevata',
      ...
      scanSubnetMoonraker: 'Scansiona sottorete per Moonraker',
      discoverNetwork: 'Trova stampanti in rete',
      scanningSubnet: 'Scansione sottorete per stampanti Bambu...',
      scanningSubnetMoonraker: 'Scansione sottorete per stampanti Moonraker...',
      scanningNetwork: 'Scansione rete...',
      noPrintersFoundSubnetMoonraker: 'Nessuna istanza Moonraker trovata nella sottorete specificata.',
      moonrakerNeedsAuth: 'Questa istanza Moonraker richiede un token API — inseriscilo sotto.',
      moonrakerSubnetNote: 'Cerca l’API Moonraker/Klipper sulle porte sotto (predefinito 7125 poi 80 per CosmOS/Fluidd). Usa lo stesso elenco di sottoreti di Bambu, incluso DISCOVERY_EXTRA_SUBNETS.',
      moonrakerPorts: 'Porte da scansionare',
      moonrakerPortsNote: 'Separate da virgola. Usa 80 per CosmOS / Moonraker in proxy. Solo gli host che restituiscono JSON Moonraker vengono elencati.',
    ...
    openPrusaLink: 'Apri PrusaLink',
    openPrusaLinkNewTab: 'Apri PrusaLink in una nuova scheda',
  ...
  profiles: {
    ...
    openFilamentDatabase: {
      ...
      subtitle: 'Scegli se PrintBuddy deve cercare dati sui filamenti tramite Open Filament Database.',
      enableLabel: 'Cerca bobine tramite Open Filament Database',
      enableDescription: 'Attiva questa opzione per cercare dati sui filamenti in Open Filament Database quando crei bobine locali di inventario.',
      failedToLoad: 'Impossibile caricare le impostazioni di Open Filament Database',
      noPermission: 'Non hai il permesso di aggiornare questa impostazione.',
      toast: {
        updated: 'Impostazione Open Filament Database aggiornata',
      },
    },
  ...
  fileManager: {
    ...
    sourceDetails: 'Dettagli origine',
    sourceArchive: 'Dettagli MakerWorld archiviati',
    sourceArchiveLoadError: 'Impossibile caricare i dettagli origine archiviati.',
    sourceCapturedAt: 'Archiviato il {{date}}',
    gridView: 'Vista griglia',
    listView: 'Vista elenco',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      searchToggle: 'Cerca tramite Open Filament Database',
      searchHint: 'Cerca prima i marchi OFDB, poi seleziona materiale, filamento, variante e dimensione per precompilare questa bobina locale.',
      brandLabel: 'Marchio OFDB',
      brandPlaceholder: 'Cerca marchi OFDB...',
      materialLabel: 'Materiale OFDB',
      filamentLabel: 'Filamento OFDB',
      loadingBrands: 'Caricamento marchi OFDB...',
      brandLoadFailed: 'Impossibile caricare i marchi OFDB',
      materialLoadFailed: 'Impossibile caricare i materiali OFDB per questo marchio',
      noBrands: 'Nessun marchio OFDB trovato.',
      noMaterials: 'Questo marchio OFDB non ha materiali da selezionare.',
      searchPlaceholder: 'Cerca filamenti per il marchio/materiale selezionato...',
      brandMaterialHint: 'Seleziona un marchio e un materiale OFDB prima di cercare filamenti.',
      missingBrandMaterial: 'Sono richiesti un marchio e un materiale OFDB prima di cercare filamenti.',
      searchFailed: 'Ricerca Open Filament Database non riuscita',
      filamentLoadFailed: 'Impossibile caricare i dettagli del filamento OFDB',
      variantLoadFailed: 'Impossibile caricare i dettagli della variante OFDB',
      noFilaments: 'Nessun filamento OFDB trovato per questo marchio/materiale.',
      noVariants: 'Questo filamento OFDB non ha varianti da selezionare.',
      filamentResults: 'Filamenti',
      variantResults: 'Varianti / colori',
      materialCount: '{{count}} materiale/i',
      filamentCount: '{{count}} filamento/i',
      variantCount: '{{count}} variante/i',
      sizeCount: '{{count}} dimensione/i',
    },
    ...
    spoolmanSpoolWeight: 'Peso bobina vuota',
    spoolmanSpoolWeightPlaceholder: 'Lascia vuoto',
    spoolmanSpoolWeightHelp: 'Facoltativo. Salvato in Spoolman come peso a vuoto di questa bobina. Lascia vuoto per usare il valore del filamento o del produttore.',
    ...
    spoolWeightManagedBySpoolman: 'Il peso della bobina vuota è gestito in Spoolman.',
  ...
  backup: {
    ...
    repositoryUrlInitialCommitHint: 'Nota: dopo aver creato il repository, crea un commit iniziale (ad esempio aggiungendo un file README) prima di abilitare il backup. Printbuddy può scrivere solo su un branch già esistente.',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notifiche push tramite l’app Notify',
    },
    ...
    selectedPrinters: 'Stampanti selezionate',
    noPrintersAvailable: 'Nessuna stampante disponibile',
    onlyFromSelectedPrinters: 'Invia notifiche solo per eventi dalle stampanti selezionate',
    fromAllPrinters: 'Invia notifiche per eventi da tutte le stampanti',
    selectAtLeastOnePrinter: 'Seleziona almeno una stampante oppure scegli Tutte le stampanti.',
  ...
  makerworld: {
    ...
    importDefaults: 'Impostazioni predefinite di importazione',
    importDefaultsDescription: 'Applica queste scelte automaticamente alle nuove importazioni MakerWorld. Puoi comunque modificarle per ogni importazione.',
    archiveDetailsByDefault: 'Archivia i dettagli MakerWorld per impostazione predefinita',
    archiveDetailsByDefaultDescription: 'Salva localmente descrizione, istruzioni e immagini del modello.',
    useCoverAsThumbnailByDefault: 'Usa la copertina archiviata come miniatura della libreria per impostazione predefinita',
    useCoverAsThumbnailByDefaultDescription: 'Attiva anche l’archiviazione dei dettagli, poiché la miniatura usa la copertina archiviata locale.',
    importDefaultsSaved: 'Impostazioni predefinite di importazione MakerWorld salvate.',
    importDefaultsSaveFailed: 'Impossibile salvare le impostazioni predefinite MakerWorld.',
    archiveDetailsDefaultControl: 'Archivio sorgente predefinito',
    coverThumbnailDefaultControl: 'Miniatura di copertina della libreria predefinita',
    ...
    selectProfile: 'Seleziona {{profile}}',
