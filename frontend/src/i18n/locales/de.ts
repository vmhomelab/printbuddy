export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      moonrakerSubnetNote: 'Sucht Moonraker/Klipper-API-JSON auf den Ports unten (Standard 7125, dann 80 für CosmOS/Fluidd). Nutzt dieselbe Subnetz-Liste wie Bambu, inkl. DISCOVERY_EXTRA_SUBNETS.',
      moonrakerPorts: 'Zu scannende Ports',
      moonrakerPortsNote: 'Kommagetrennt. Port 80 für CosmOS / proxied Moonraker. Nur Hosts mit Moonraker-API-JSON werden gelistet.',
  ...
  fileManager: {
    ...
    sourceArchive: 'Archivierte MakerWorld-Details',
    sourceArchiveLoadError: 'Die archivierten Quelldetails konnten nicht geladen werden.',
    sourceCapturedAt: 'Archiviert am {{date}}',
    gridView: 'Rasteransicht',
    listView: 'Listenansicht',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Push-Benachrichtigungen über die Notify-App',
    },
    ...
    selectedPrinters: 'Ausgewählte Drucker',
    noPrintersAvailable: 'Keine Drucker verfügbar',
    onlyFromSelectedPrinters: 'Benachrichtigungen nur für Ereignisse der ausgewählten Drucker senden',
    fromAllPrinters: 'Benachrichtigungen für Ereignisse von allen Druckern senden',
    selectAtLeastOnePrinter: 'Wähle mindestens einen Drucker aus oder wähle Alle Drucker.',
  ...
  makerworld: {
    ...
    importDefaults: 'Import-Standardeinstellungen',
    importDefaultsDescription: 'Diese Auswahl automatisch auf neue MakerWorld-Importe anwenden. Sie kann pro Import überschrieben werden.',
    archiveDetailsByDefault: 'MakerWorld-Details standardmäßig archivieren',
    archiveDetailsByDefaultDescription: 'Modellbeschreibung, Anleitungen und Anzeige-Bilder lokal speichern.',
    useCoverAsThumbnailByDefault: 'Archiviertes Titelbild standardmäßig als Bibliotheksvorschau verwenden',
    useCoverAsThumbnailByDefaultDescription: 'Aktiviert auch die Detailarchivierung, da die Vorschau das lokale archivierte Titelbild verwendet.',
    importDefaultsSaved: 'MakerWorld-Importstandards gespeichert.',
    importDefaultsSaveFailed: 'MakerWorld-Importstandards konnten nicht gespeichert werden.',
    archiveDetailsDefaultControl: 'Standardmäßiges Quellenarchiv',
    coverThumbnailDefaultControl: 'Standardmäßiges Bibliotheks-Titelbild',
