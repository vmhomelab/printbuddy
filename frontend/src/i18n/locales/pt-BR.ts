export default {
  ...
  nav: {
    ...
    stats: 'Estatísticas',
    farmMonitor: 'Monitor da fazenda',
    farmCommandCenter: 'Centro de comando da fazenda',
    profiles: 'Perfis',
    ...
    installAppSuccess: 'Printbuddy foi instalado',
  },
  ...
  printers: {
    ...
    discovery: {
      ...
      scanSubnetMoonraker: 'Escanear Sub-rede para Moonraker',
      discoverNetwork: 'Descobrir Impressoras na Rede',
      scanningSubnet: 'Escaneando sub-rede para impressoras Bambu...',
      scanningSubnetMoonraker: 'Escaneando sub-rede para impressoras Moonraker...',
      scanningNetwork: 'Escaneando rede...',
      noPrintersFoundSubnetMoonraker: 'Nenhuma instância Moonraker encontrada na sub-rede especificada.',
      moonrakerNeedsAuth: 'Esta instância Moonraker exige um token de API — informe abaixo.',
      moonrakerSubnetNote: 'Procura a API Moonraker/Klipper nas portas abaixo (padrão 7125 e depois 80 para CosmOS/Fluidd). Usa a mesma lista de sub-redes do Bambu, incluindo DISCOVERY_EXTRA_SUBNETS.',
      moonrakerPorts: 'Portas para escanear',
      moonrakerPortsNote: 'Separadas por vírgula. Use 80 para CosmOS / Moonraker com proxy. Só hosts com JSON da API Moonraker são listados.',
    ...
    fans: {
      ...
      heatbreak: 'Ventoinha do heatbreak',
    },
    // HMS errors
    ...
    dropNotPrintable: 'Apenas arquivos {{extensions}} podem ser impressos nesta impressora',
    printUploadAccepts: 'Arquivos imprimíveis para esta impressora: {{extensions}}',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Grupos LDAP são mapeados para grupos Printbuddy no login',
      ...
      autoProvisionHint: 'Criar automaticamente uma conta Printbuddy no primeiro login LDAP',
      ...
      groupMappingHint: 'Mapear DNs de grupos LDAP para grupos Printbuddy. Grupos disponíveis: ',
    ...
    authDisabledMessage: 'Ative a autenticação para criar contas de usuário, gerenciar permissões e proteger sua instância do Printbuddy.',
    ...
    disableAuthenticationMessage: 'Tem certeza de que deseja desativar a autenticação? Isso tornará sua instância do Printbuddy acessível sem login. Todos os usuários permanecerão no banco de dados, mas a autenticação será desativada.',
    ...
    printbuddySoftware: 'Software Printbuddy',
    ...
    updateViaHomeAssistant: 'As atualizações são gerenciadas pelo Supervisor do Home Assistant. Abra Configurações → Complementos → Printbuddy no Home Assistant para instalar a nova versão.',
    ...
    externalUrlDescription: 'A URL externa onde o Printbuddy está acessível. Usada para imagens de notificação e integrações externas.',
    printbuddyUrl: 'URL do Printbuddy',
    ...
    mqttDescription: 'Publique eventos do Printbuddy para um broker MQTT externo para integração com Node-RED, Home Assistant e outros sistemas de automação.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Os segredos TOTP e client_secrets OIDC são armazenados em texto plano. Defina MFA_ENCRYPTION_KEY ou reinicie o Printbuddy com um diretório de dados gravável para gerar automaticamente.',
      ...
      migrationErrorWarning: '{{count}} linha(s) antiga(s) não puderam ser recriptografadas na inicialização. Verifique os logs do servidor e reinicie o Printbuddy para tentar novamente.',
    },
  ...
  login: {
    ...
    resetStep1: 'Entre em contato com o administrador do Printbuddy',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra seu aplicativo autenticador e insira o código de 6 dígitos gerado para o Printbuddy.',
  ...
  // Setup page
  setup: {
    title: 'Printbuddy Configuração',
    subtitle: 'Configure a autenticação para sua instância do Printbuddy',
  ...
  users: {
    ...
    subtitle: 'Gerenciar usuários e seu acesso à sua instância do Printbuddy',
    backToSettings: 'Voltar para Configurações',
    createUser: 'Criar Usuário',
    noPermission: 'Você não tem permissão para acessar esta página.',
    admin: 'Administrador',
  ...
  profiles: {
    ...
    openFilamentDatabase: {
      ...
      subtitle: 'Escolha se o PrintBuddy deve buscar dados de filamento via Open Filament Database.',
      enableLabel: 'Buscar carretéis via Open Filament Database',
      enableDescription: 'Ative esta opção para buscar dados de filamento no Open Filament Database ao criar carretéis locais de inventário.',
      failedToLoad: 'Não foi possível carregar as configurações do Open Filament Database',
      noPermission: 'Você não tem permissão para atualizar esta configuração.',
      toast: {
        updated: 'Configuração do Open Filament Database atualizada',
      },
    },
  ...
  fileManager: {
    ...
    prusaUploadPatienceNote: 'Uploads para Prusa podem levar de alguns segundos a alguns minutos dependendo do tamanho do arquivo enquanto a impressora grava o arquivo no armazenamento USB.',
    ...
    sourceArchive: 'Detalhes arquivados do MakerWorld',
    sourceArchiveLoadError: 'Não foi possível carregar os detalhes arquivados da origem.',
    sourceCapturedAt: 'Arquivado em {{date}}',
    gridView: 'Visualização em grade',
    listView: 'Visualização em lista',
    lowDiskSpaceWarning: 'Aviso de pouco espaço em disco',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'O Printbuddy é servido via HTTPS (pelo seu reverse proxy), mas a URL do Spoolman ainda é HTTP. Os navegadores bloqueiam conteúdo misto por segurança, então a interface embutida do Spoolman não consegue carregar. O Spoolman também precisa estar acessível via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Coloque o Spoolman atrás do mesmo reverse proxy do Printbuddy (Traefik / Nginx / Caddy) com HTTPS e atualize a URL do Spoolman em Configurações com o novo endereço HTTPS.',
    ...
    openFilamentDatabase: {
      searchToggle: 'Buscar via Open Filament Database',
      searchHint: 'Busque primeiro marcas OFDB e depois selecione material, filamento, variante e tamanho para preencher este carretel local.',
      brandLabel: 'Marca OFDB',
      brandPlaceholder: 'Buscar marcas OFDB...',
      materialLabel: 'Material OFDB',
      filamentLabel: 'Filamento OFDB',
      loadingBrands: 'Carregando marcas OFDB...',
      brandLoadFailed: 'Não foi possível carregar marcas OFDB',
      materialLoadFailed: 'Não foi possível carregar materiais OFDB para esta marca',
      noBrands: 'Nenhuma marca OFDB encontrada.',
      noMaterials: 'Esta marca OFDB não tem materiais para selecionar.',
      searchPlaceholder: 'Buscar filamentos para a marca/material selecionado...',
      brandMaterialHint: 'Selecione uma marca e um material OFDB antes de buscar filamentos.',
      missingBrandMaterial: 'Uma marca e um material OFDB são obrigatórios antes de buscar filamentos.',
      searchFailed: 'Falha na busca do Open Filament Database',
      filamentLoadFailed: 'Não foi possível carregar detalhes do filamento OFDB',
      variantLoadFailed: 'Não foi possível carregar detalhes da variante OFDB',
      noFilaments: 'Nenhum filamento OFDB encontrado para esta marca/material.',
      noVariants: 'Este filamento OFDB não tem variantes para selecionar.',
      filamentResults: 'Filamentos',
      variantResults: 'Variantes / cores',
      materialCount: '{{count}} material(is)',
      filamentCount: '{{count}} filamento(s)',
      variantCount: '{{count}} variante(s)',
      sizeCount: '{{count}} tamanho(s)',
    },
  ...
  backup: {
    ...
    appSettingsDescription: 'Configuração do Printbuddy (banco de dados completo)',
    ...
    localBackupDescription: 'Crie um backup completo dos seus dados do Printbuddy incluindo banco de dados, arquivos, uploads e todos os ficheiros.',
    ...
    backupRestoredRestart: 'Backup restaurado. Por favor, reinicie o Printbuddy.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'As notas são salvas no Printbuddy, não na impressora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visível como "Printbuddy" na descoberta do slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Substitua o endereço IP anunciado via SSDP e usado no certificado TLS. Útil quando o Printbuddy possui várias interfaces de rede.',
    },
    mode: {
      title: 'Modo',
      archive: 'Arquivar',
    ...
    caCert: {
      ...
      description: 'As impressoras virtuais usam um certificado TLS assinado pela CA do Printbuddy. Importe este certificado CA para o armazenamento de confiança do seu slicer uma única vez para que ele aceite a conexão — sem precisar copiá-lo pela linha de comando.',
      copy: 'Copiar',
      copied: 'Copiado',
      download: 'Baixar',
      fingerprint: 'SHA-256',
  ...
  notifications: {
    ...
    noPrintersAvailable: 'Nenhuma impressora disponível',
    onlyFromSelectedPrinters: 'Enviar notificações apenas para eventos das impressoras selecionadas',
    fromAllPrinters: 'Enviar notificações para eventos de todas as impressoras',
    selectAtLeastOnePrinter: 'Selecione pelo menos uma impressora ou escolha Todas as impressoras.',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'O Printbuddy está sendo executado em rede Docker bridge. A descoberta de impressoras e a impressora virtual precisam do modo de rede host — recrie o contêiner com "network_mode: host".',
        skip: 'Não está sendo executado no Docker — não aplicável.',
      },
      subnet: {
        title: 'Sub-rede',
        pass: 'A impressora e o Printbuddy estão na mesma sub-rede.',
        warn: 'A impressora ({{printer_ip}}) e o Printbuddy ({{host_ip}}) estão em sub-redes diferentes. Eles podem não se alcançar, a menos que o roteamento entre as sub-redes esteja configurado.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Copie novamente o código de acesso da tela da impressora (configurações de LAN) e atualize-o nas configurações da impressora no Printbuddy.',
      },
      'ftp-connection-timeout': {
        name: 'Tempo limite da conexão de transferência de arquivos',
        cause: 'O Printbuddy não conseguiu acessar a porta de transferência de arquivos da impressora (FTPS 990). A porta está bloqueada, ou a impressora está desligada ou em outra sub-rede.',
        fix: 'Verifique se nada bloqueia a porta 990 entre o Printbuddy e a impressora e se ambos estão na mesma rede.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Migre o Printbuddy para um banco de dados PostgreSQL externo. Consulte o guia do PostgreSQL na documentação.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'A impressora virtual está habilitada, mas seus serviços não estão em execução. Verifique o log do Printbuddy — geralmente um conflito de IP de vínculo ou um erro de permissão os interrompe.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificado pronto. Verifique se o certificado CA do Printbuddy (acima) está importado no armazenamento de confiança do seu slicer.',
        fail: 'O certificado TLS desta impressora virtual está ausente. Verifique se o diretório de dados do Printbuddy tem permissão de escrita.',
      },
    },
  },
  ...
  bugReport: {
    ...
    submittingStepSubmit: 'Preparando link de issue do GitHub',
    ...
    prepared: 'Relatório de bug preparado',
    preparedMessage: 'Revise a issue preparada no GitHub e envie manualmente.',
  ...
  failureDetection: {
    ...
    externalUrlHint: 'A API ML busca a captura da câmera por URL. Defina a URL externa nas configurações gerais para que o contêiner da API ML possa alcançar o Printbuddy.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Cole uma URL de modelo do MakerWorld para importar e imprimir diretamente do Printbuddy — sem precisar abrir o app Bambu Handy.',
    ...
    archiveDetails: 'Arquivar detalhes do MakerWorld',
    archiveDetailsDescription: 'Salvar localmente a descrição e a imagem de capa com o arquivo importado.',
    importDefaults: 'Padrões de importação',
    importDefaultsDescription: 'Aplica estas escolhas automaticamente às novas importações do MakerWorld. Você ainda pode substituí-las por importação.',
    archiveDetailsByDefault: 'Arquivar detalhes do MakerWorld por padrão',
    archiveDetailsByDefaultDescription: 'Salva localmente a descrição, as instruções e as imagens do modelo.',
    useCoverAsThumbnailByDefault: 'Usar capa arquivada como miniatura da biblioteca por padrão',
    useCoverAsThumbnailByDefaultDescription: 'Também ativa o arquivamento de detalhes, pois a miniatura usa a capa local arquivada.',
    importDefaultsSaved: 'Padrões de importação do MakerWorld salvos.',
    importDefaultsSaveFailed: 'Não foi possível salvar os padrões do MakerWorld.',
    archiveDetailsDefaultControl: 'Arquivar detalhes do MakerWorld por padrão',
    coverThumbnailDefaultControl: 'Usar capa arquivada como miniatura da biblioteca por padrão',
    useCoverAsThumbnail: 'Usar capa do MakerWorld como miniatura da biblioteca',
    useCoverAsThumbnailDescription: 'Usa a imagem de capa do MakerWorld arquivada localmente como miniatura da biblioteca deste arquivo.',
    archivePartialWarning: 'O modelo foi salvo, mas algumas imagens do MakerWorld não puderam ser arquivadas.',
    archiveFailedWarning: 'O modelo foi salvo, mas os detalhes do MakerWorld não puderam ser arquivados.',
    sliceIn: 'Salvar e fatiar no {{slicer}}',
    disclaimer: 'A integração com o MakerWorld usa endpoints de API documentados pela comunidade. Printbuddy não é afiliado nem endossado pelo MakerWorld ou pela Bambu Lab.',
    ...
    importSelected: 'Importar selecionados ({{count}})',
    selectProfile: 'Selecionar {{profile}}',
  ...
  libraryPurge: {
    ...
    effect4: 'Arquivos em pastas externas (vinculadas) são ignorados — Printbuddy nunca exclui bytes que não possui.',    previewLoading: 'Verificando quantos arquivos correspondem…',
