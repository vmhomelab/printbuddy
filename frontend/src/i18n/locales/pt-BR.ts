export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      moonrakerSubnetNote: 'Procura Moonraker apenas na porta 7125 (exige JSON da API Moonraker/Klipper). Usa a mesma lista de sub-redes do Bambu, incluindo DISCOVERY_EXTRA_SUBNETS.',
