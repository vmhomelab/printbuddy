export default {
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      searchHint: 'Uses the current Brand and Material fields as the OFDB search scope.',
      searchPlaceholder: 'Search Open Filament Database...',
      brandMaterialHint: 'Select or enter a brand and material before searching OFDB.',
      missingBrandMaterial: 'Brand and material are required before searching Open Filament Database.',
