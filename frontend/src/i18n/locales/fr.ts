export default {
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      searchToggle: 'Search via Open Filament Database',
      searchHint: 'Search OFDB brands first, then select material, filament, variant, and size to prefill this local spool.',
      brandLabel: 'OFDB brand',
      brandPlaceholder: 'Search OFDB brands...',
      materialLabel: 'OFDB material',
      filamentLabel: 'OFDB filament',
      loadingBrands: 'Loading OFDB brands...',
      brandLoadFailed: 'Could not load OFDB brands',
      materialLoadFailed: 'Could not load OFDB materials for this brand',
      noBrands: 'No OFDB brands found.',
      noMaterials: 'This OFDB brand has no materials to select.',
      searchPlaceholder: 'Search filaments for selected brand/material...',
      brandMaterialHint: 'Select an OFDB brand and material before searching filaments.',
      missingBrandMaterial: 'An OFDB brand and material are required before searching filaments.',
      searchFailed: 'Open Filament Database search failed',
      filamentLoadFailed: 'Could not load OFDB filament details',
      variantLoadFailed: 'Could not load OFDB variant details',
      noFilaments: 'No OFDB filaments found for this brand/material.',
      noVariants: 'This OFDB filament has no variants to select.',
      filamentResults: 'Filaments',
      variantResults: 'Variants / colors',
      materialCount: '{{count}} material(s)',
      filamentCount: '{{count}} filament(s)',
      variantCount: '{{count}} variant(s)',
      sizeCount: '{{count}} size(s)',
    },
