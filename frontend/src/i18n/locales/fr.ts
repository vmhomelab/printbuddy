export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      scanSubnetMoonraker: 'Scanner le sous-réseau pour Moonraker',
      discoverNetwork: 'Découvrir sur le réseau',
      scanningSubnet: 'Scan du sous-réseau pour imprimantes Bambu...',
      scanningSubnetMoonraker: 'Scan du sous-réseau pour imprimantes Moonraker...',
      scanningNetwork: 'Scan du réseau...',
      noPrintersFoundSubnetMoonraker: 'Aucune instance Moonraker trouvée dans le sous-réseau spécifié.',
      moonrakerNeedsAuth: 'Cette instance Moonraker nécessite un jeton API — saisissez-le ci-dessous.',
      moonrakerSubnetNote: 'Recherche l’API Moonraker/Klipper sur les ports ci-dessous (défaut 7125 puis 80 pour CosmOS/Fluidd). Utilise la même liste de sous-réseaux que Bambu, y compris DISCOVERY_EXTRA_SUBNETS.',
      moonrakerPorts: 'Ports à scanner',
      moonrakerPortsNote: 'Séparés par des virgules. Utilisez 80 pour CosmOS / Moonraker proxifié. Seuls les hôtes renvoyant du JSON Moonraker sont listés.',
  ...
  fileManager: {
    ...
    sourceArchive: 'Détails MakerWorld archivés',
    sourceArchiveLoadError: 'Impossible de charger les détails de source archivés.',
    sourceCapturedAt: 'Archivé le {{date}}',
    gridView: 'Grille',
    listView: 'Liste',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notifications push via l’application Notify',
    },
    ...
    noPrintersAvailable: 'Aucune imprimante disponible',
    onlyFromSelectedPrinters: 'Envoyer des notifications uniquement pour les événements des imprimantes sélectionnées',
    fromAllPrinters: 'Envoyer des notifications pour les événements de toutes les imprimantes',
    selectAtLeastOnePrinter: 'Sélectionnez au moins une imprimante ou choisissez Toutes les imprimantes.',
  ...
  makerworld: {
    ...
    importDefaults: 'Paramètres d’importation par défaut',
    importDefaultsDescription: 'Appliquez ces choix automatiquement aux nouvelles importations MakerWorld. Vous pouvez toujours les modifier par importation.',
    archiveDetailsByDefault: 'Archiver les détails MakerWorld par défaut',
    archiveDetailsByDefaultDescription: 'Enregistre localement la description, les instructions et les images du modèle.',
    useCoverAsThumbnailByDefault: 'Utiliser la couverture archivée comme miniature de bibliothèque par défaut',
    useCoverAsThumbnailByDefaultDescription: 'Active aussi l’archivage des détails, car la miniature utilise la couverture archivée locale.',
    importDefaultsSaved: 'Paramètres d’importation MakerWorld enregistrés.',
    importDefaultsSaveFailed: 'Les paramètres d’importation MakerWorld n’ont pas pu être enregistrés.',
    archiveDetailsDefaultControl: 'Archive source par défaut',
    coverThumbnailDefaultControl: 'Miniature de couverture de bibliothèque par défaut',
    ...
    selectProfile: 'Sélectionner {{profile}}',
