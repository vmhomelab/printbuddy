export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      moonrakerSubnetNote: 'Recherche Moonraker uniquement sur le port 7125 (JSON API Moonraker/Klipper requis). Utilise la même liste de sous-réseaux que Bambu, y compris DISCOVERY_EXTRA_SUBNETS.',
