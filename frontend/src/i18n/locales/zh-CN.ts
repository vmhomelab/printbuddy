export default {
  ...
  printers: {
    ...
    discovery: {
      ...
      scanSubnetMoonraker: '扫描子网查找 Moonraker',
      discoverNetwork: '在网络上发现打印机',
      scanningSubnet: '正在扫描子网查找拓竹打印机...',
      scanningSubnetMoonraker: '正在扫描子网查找 Moonraker 打印机...',
      ...
      moonrakerSubnetNote: '在下方端口扫描 Moonraker/Klipper API JSON（默认先 7125，再 80 以支持 CosmOS/Fluidd）。使用与拓竹相同的子网列表，包括 DISCOVERY_EXTRA_SUBNETS。',
      moonrakerPorts: '要扫描的端口',
      moonrakerPortsNote: '逗号分隔。CosmOS / 反向代理 Moonraker 请使用 80。仅列出返回 Moonraker API JSON 的主机。',
    ...
    openPrusaLink: '打开 PrusaLink',
    openPrusaLinkNewTab: '在新标签页中打开 PrusaLink',
  ...
  settings: {
    ...
    printbuddySoftware: 'Printbuddy 软件',
  ...
  profiles: {
    ...
    tabs: {
      ...
      local: '本地配置文件',
      kprofiles: 'K 值配置',
      openFilamentDatabase: 'Open Filament Database API 设置',
    },
    localProfiles: {
      title: '本地配置文件',
    ...
    openFilamentDatabase: {
      title: 'Open Filament Database API 设置',
      subtitle: '选择 PrintBuddy 是否通过 Open Filament Database 搜索耗材数据。',
      enableLabel: '通过 Open Filament Database 搜索料盘',
      enableDescription: '启用后，在创建本地库存料盘时会从 Open Filament Database 搜索耗材数据。',
      failedToLoad: '无法加载 Open Filament Database 设置',
      noPermission: '你没有权限更新此设置。',
      toast: {
        updated: 'Open Filament Database 设置已更新',
      },
    },
    connectedAs: '已连接为',
    logout: '退出登录',
  ...
  fileManager: {
    ...
    prusaUploadPatienceNote: 'Prusa 上传可能需要几秒到几分钟，具体取决于文件大小，同时打印机会将文件写入 USB 存储。',
    ...
    sourceDetails: '来源详情',
    sourceArchive: '已归档的 MakerWorld 详情',
    sourceArchiveLoadError: '无法加载已归档的来源详情。',
    sourceCapturedAt: '归档于 {{date}}',
    gridView: '网格视图',
    listView: '列表视图',
    lowDiskSpaceWarning: '磁盘空间不足警告',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      searchToggle: '通过 Open Filament Database 搜索',
      searchHint: '先搜索 OFDB 品牌，然后选择材料、耗材、变体和尺寸来预填此本地料盘。',
      brandLabel: 'OFDB 品牌',
      brandPlaceholder: '搜索 OFDB 品牌...',
      materialLabel: 'OFDB 材料',
      filamentLabel: 'OFDB 耗材',
      loadingBrands: '正在加载 OFDB 品牌...',
      brandLoadFailed: '无法加载 OFDB 品牌',
      materialLoadFailed: '无法加载此品牌的 OFDB 材料',
      noBrands: '未找到 OFDB 品牌。',
      noMaterials: '此 OFDB 品牌没有可选择的材料。',
      searchPlaceholder: '搜索所选品牌/材料的耗材...',
      brandMaterialHint: '搜索耗材前请选择 OFDB 品牌和材料。',
      missingBrandMaterial: '搜索耗材前需要 OFDB 品牌和材料。',
      searchFailed: 'Open Filament Database 搜索失败',
      filamentLoadFailed: '无法加载 OFDB 耗材详情',
      variantLoadFailed: '无法加载 OFDB 变体详情',
      noFilaments: '未找到此品牌/材料的 OFDB 耗材。',
      noVariants: '此 OFDB 耗材没有可选择的变体。',
      filamentResults: '耗材',
      variantResults: '变体 / 颜色',
      materialCount: '{{count}} 种材料',
  ...
  backup: {
    ...
    backupSkippedNoChangesNote: '已跳过，因为没有需要保存的更改。',
  ...
  notifications: {
    ...
    selectedPrinters: '已选择的打印机',
    noPrintersAvailable: '没有可用的打印机',
    onlyFromSelectedPrinters: '仅发送所选打印机事件的通知',
    fromAllPrinters: '发送所有打印机事件的通知',
    selectAtLeastOnePrinter: '请选择至少一台打印机，或选择所有打印机。',
    quietHoursDnd: '免打扰时段',
    quietStart: '开始',
    quietEnd: '结束',
  ...
  makerworld: {
    ...
    importDefaults: '导入默认设置',
    importDefaultsDescription: '自动将这些选择应用于新的 MakerWorld 导入。您仍可针对每次导入进行覆盖。',
    archiveDetailsByDefault: '默认归档 MakerWorld 详情',
    archiveDetailsByDefaultDescription: '在本地保存模型描述、说明和展示图片。',
    useCoverAsThumbnailByDefault: '默认使用已归档封面作为库缩略图',
    useCoverAsThumbnailByDefaultDescription: '同时启用详情归档，因为缩略图使用本地归档的封面。',
    importDefaultsSaved: '已保存 MakerWorld 导入默认设置。',
    importDefaultsSaveFailed: '无法保存 MakerWorld 导入默认设置。',
    archiveDetailsDefaultControl: '默认归档 MakerWorld 详情',
    coverThumbnailDefaultControl: '默认使用已归档封面作为库缩略图',
