export default {
  ...
  nav: {
    ...
    logout: '登出',
    installApp: '安裝應用程式',
    installAppSuccess: 'Printbuddy 已安裝',
  },
  ...
  printers: {
    ...
    discovery: {
      ...
      scanSubnetMoonraker: '掃描子網查詢 Moonraker',
      discoverNetwork: '在網路上發現印表機',
      scanningSubnet: '正在掃描子網查詢拓竹印表機...',
      scanningSubnetMoonraker: '正在掃描子網查詢 Moonraker 印表機...',
      scanningNetwork: '正在掃描網路...',
      noPrintersFoundSubnetMoonraker: '在指定子網中找不到 Moonraker 執行個體。',
      moonrakerNeedsAuth: '此 Moonraker 執行個體需要 API 權杖 — 請在下方輸入。',
      moonrakerSubnetNote: '在下方連接埠掃描 Moonraker/Klipper API JSON（預設先 7125，再 80 以支援 CosmOS/Fluidd）。使用與拓竹相同的子網清單，包括 DISCOVERY_EXTRA_SUBNETS。',
      moonrakerPorts: '要掃描的連接埠',
      moonrakerPortsNote: '以逗號分隔。CosmOS / 反向代理 Moonraker 請使用 80。僅列出回傳 Moonraker API JSON 的主機。',
    ...
    dropNotPrintable: '此印表機只能列印 {{extensions}} 檔案',
    printUploadAccepts: '此印表機可列印的檔案：{{extensions}}',
    dropToPrint: '拖放以列印',
    cannotPrint: '印表機忙碌',
  },
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: '登入時 LDAP 群組對應到 Printbuddy 群組',
    ...
    authDisabledMessage: '啟用身份驗證以建立使用者帳戶、管理權限並保護您的 Printbuddy 實例。',
    ...
    disableAuthenticationMessage: '確定要停用身份驗證嗎？這將使您的 Printbuddy 實例無需登入即可存取。所有使用者將保留在資料庫中但身份驗證將被停用。',
    disableAuthentication: '停用身份驗證',
    // Additional settings
    configurePrintbuddy: '設定 Printbuddy',
    systemDefault: '系統預設',
    ...
    printbuddySoftware: 'Printbuddy 軟體',
    autoCheckDescription: '啟動時自動檢查新版本',
    checkNow: '立即檢查',
    updateAvailableVersion: '可用更新：v{{version}}',
    releaseNotes: '發布說明',
    updateViaDocker: '透過 Docker Compose 更新：',
    updateViaHomeAssistant: '更新由 Home Assistant Supervisor 管理。請在 Home Assistant 中開啟 設定 → 附加元件 → Printbuddy 以安裝新版本。',
    installUpdate: '安裝更新',
    ...
    goToBackup: '前往備份',
    externalUrl: '外部URL',
    externalUrlDescription: 'Printbuddy可存取的外部URL。用於通知影像和外部整合。',
    ...
    mqttDescription: '將Printbuddy事件發布到外部MQTT代理，用於與Node-RED、Home Assistant和其他自動化系統整合。',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP 機密和 OIDC client_secrets 以明文儲存。請設定 MFA_ENCRYPTION_KEY 或使用可寫資料目錄重新啟動 Printbuddy 以自動產生。',
      ...
      migrationErrorWarning: '{{count}} 行舊資料在啟動時未能重新加密。請檢查伺服器日誌並重新啟動 Printbuddy 以重試。',
    },
  ...
  login: {
    ...
    howToReset: '如何重設密碼：',
    resetStep1: '聯絡您的 Printbuddy 管理員',
    ...
    twoFA: {
      ...
      methodEmail: '信箱驗證碼',
      methodBackup: '備用恢復碼',
      instructionsTotp: '請開啟您的身份驗證器 App，輸入 Printbuddy 的 6 位驗證碼。',
  ...
  setup: {
    title: 'Printbuddy 設定',
    subtitle: '為您的 Printbuddy 實例設定身份驗證',
    enableAuth: '啟用身份驗證',
    adminAccount: '管理員帳戶',
  ...
  users: {
    title: '使用者管理',
    subtitle: '管理使用者及其對 Printbuddy 實例的存取',
    backToSettings: '返回設定',
    createUser: '建立使用者',
    noPermission: '您沒有存取此頁面的權限。',
    admin: '管理員',
  ...
  profiles: {
    ...
    openFilamentDatabase: {
      ...
      subtitle: '選擇 PrintBuddy 是否透過 Open Filament Database 搜尋耗材資料。',
      enableLabel: '透過 Open Filament Database 搜尋料盤',
      enableDescription: '啟用後，在建立本機庫存料盤時會從 Open Filament Database 搜尋耗材資料。',
      failedToLoad: '無法載入 Open Filament Database 設定',
      noPermission: '你沒有權限更新此設定。',
      toast: {
        updated: 'Open Filament Database 設定已更新',
      },
    },
    connectedAs: '已連線為',
    logout: '登出',
  ...
  fileManager: {
    ...
    prusaUploadPatienceNote: 'Prusa 上傳可能需要幾秒到幾分鐘，視檔案大小而定，同時印表機會將檔案寫入 USB 儲存裝置。',
    ...
    sourceDetails: '來源詳情',
    sourceArchive: '已封存的 MakerWorld 詳情',
    sourceArchiveLoadError: '無法載入已封存的來源詳情。',
    sourceCapturedAt: '封存於 {{date}}',
    gridView: '網格檢視',
    listView: '列表檢視',
    lowDiskSpaceWarning: '磁碟空間不足警告',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Printbuddy 透過您的反向代理以 HTTPS 提供服務，但您的 Spoolman 位址仍為 HTTP。基於安全考量，瀏覽器會封鎖混合內容，因此內嵌的 Spoolman 介面無法載入。Spoolman 也必須可透過 HTTPS 存取。',
    spoolmanMixedContentFixReverseProxy: '請將 Spoolman 置於與 Printbuddy 相同的反向代理（Traefik / Nginx / Caddy）之後並啟用 HTTPS，然後在設定中將 Spoolman URL 更新為新的 HTTPS 位址。',
    ...
    openFilamentDatabase: {
      searchToggle: '透過 Open Filament Database 搜尋',
      searchHint: '先搜尋 OFDB 品牌，然後選擇材料、耗材、變體和尺寸來預填此本機料盤。',
      brandLabel: 'OFDB 品牌',
      brandPlaceholder: '搜尋 OFDB 品牌...',
      materialLabel: 'OFDB 材料',
      filamentLabel: 'OFDB 耗材',
      loadingBrands: '正在載入 OFDB 品牌...',
      brandLoadFailed: '無法載入 OFDB 品牌',
      materialLoadFailed: '無法載入此品牌的 OFDB 材料',
      noBrands: '找不到 OFDB 品牌。',
      noMaterials: '此 OFDB 品牌沒有可選擇的材料。',
      searchPlaceholder: '搜尋所選品牌/材料的耗材...',
      brandMaterialHint: '搜尋耗材前請選擇 OFDB 品牌和材料。',
      missingBrandMaterial: '搜尋耗材前需要 OFDB 品牌和材料。',
      searchFailed: 'Open Filament Database 搜尋失敗',
      filamentLoadFailed: '無法載入 OFDB 耗材詳細資料',
      variantLoadFailed: '無法載入 OFDB 變體詳細資料',
      noFilaments: '找不到此品牌/材料的 OFDB 耗材。',
      noVariants: '此 OFDB 耗材沒有可選擇的變體。',
      filamentResults: '耗材',
      variantResults: '變體 / 顏色',
      materialCount: '{{count}} 種材料',
  ...
  backup: {
    ...
    repoIsPublicWarning: '儲存庫為公開（PUBLIC）。Printbuddy 備份包含 MQTT 認證、Home Assistant 權杖、Prometheus 權杖、您的 Bambu Cloud 電子郵件，以及透過 K-profile 暴露的印表機存取碼。在您於服務商設定中將儲存庫改為私有之前，儲存將被阻擋。',
    repoVisibilityUnknown: '無法確認儲存庫的可見性。Printbuddy 拒絕向任何未確認為私有的目標進行備份；儲存將被阻擋。',
    repositoryUrl: '倉庫 URL',
    repositoryUrlInitialCommitHint: '注意：建立儲存庫後，請先進行一次初始提交（例如新增 README 檔案），再啟用備份。Printbuddy 只能寫入已經存在的分支。',
    ...
    appSettings: '應用程式設定',
    appSettingsDescription: 'Printbuddy 設定（完整資料庫）',
    spoolInventory: '耗材庫存',
    ...
    // Local Backup
    localBackup: '本機備份',
    localBackupDescription: '建立 Printbuddy 資料的完整備份，包括資料庫、檔案、上傳和所有檔案。',
    ...
    backupRestoredRestart: '備份已恢復。請重新啟動 Printbuddy。',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: '備註儲存在 Printbuddy 中，不在印表機上',
      syncing: '與印表機同步中...',
  ...
  virtualPrinter: {
    ...
    enable: {
      title: '啟用虛擬印表機',
      visibleInSlicer: '在切片軟體發現中顯示為"Printbuddy"',
      proxyingTo: '代理到 {{name}}',
      notActive: '未啟用',
    },
    model: {
    ...
    remoteInterface: {
      ...
      placeholder: '自動檢測（預設）...',
      hint: '覆蓋透過 SSDP 廣播並在 TLS 憑證中使用的 IP 位址。在 Printbuddy 有多個網路介面時很有用。',
    },
    mode: {
      title: '模式',
      archive: '歸檔',
    ...
    caCert: {
      title: '切片軟體憑證',
      description: '虛擬印表機使用由 Printbuddy CA 簽發的 TLS 憑證。將此 CA 憑證匯入切片軟體的信任庫一次，切片軟體即可接受連線 — 無需再透過命令列取得。',
      copy: '複製',
      copied: '已複製',
      download: '下載',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: '在歸檔、審核和佇列模式下，使用切片軟體中的"傳送"按鈕將 3MF 檔案上傳到 Printbuddy。切片軟體會顯示"列印成功"— 檔案已儲存，未列印。',
  ...
  notifications: {
    ...
    printAlmostDone: '列印即將完成',
    printAlmostDoneDescription: '達到 99% 時傳送含攝影機截圖的通知',
    printerOffline: '印表機離線',
    printerError: '印表機錯誤',
    ...
    selectedPrinters: '已選擇的印表機',
    noPrintersAvailable: '沒有可用的印表機',
    onlyFromSelectedPrinters: '僅傳送所選印表機事件的通知',
    fromAllPrinters: '傳送所有印表機事件的通知',
    selectAtLeastOnePrinter: '請選擇至少一台印表機，或選擇所有印表機。',
    quietHoursDnd: '免打擾時段',
    quietStart: '開始',
    quietEnd: '結束',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'Printbuddy 正在以 Docker bridge 網路執行。印表機探索與虛擬印表機需要 host 網路模式 — 請使用 "network_mode: host" 重新建立容器。',
        skip: '未在 Docker 中執行 — 不適用。',
      },
      subnet: {
        title: '網路子網路',
        pass: '印表機與 Printbuddy 位於同一子網路。',
        warn: '印表機（{{printer_ip}}）與 Printbuddy（{{host_ip}}）位於不同的子網路。除非設定了子網路之間的路由，否則它們可能無法互相連線。',
        skip: '無法判定子網路 — 已略過。',
      },
      mqtt_auth: {
        title: '印表機認證資訊',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: '從印表機螢幕（區域網路設定）重新複製存取碼，並在 Printbuddy 的印表機設定中更新。',
      },
      'ftp-connection-timeout': {
        name: '檔案傳輸連線逾時',
        cause: 'Printbuddy 無法連線印表機的檔案傳輸連接埠（FTPS 990）。該連接埠被封鎖，或印表機已關機或位於其他子網路。',
        fix: '請確認 Printbuddy 與印表機之間的 990 連接埠未被封鎖，且兩者位於同一網路。',
      },
      'ftp-ssl-error': {
        name: '安全檔案傳輸交握失敗',
      ...
      'database-locked': {
        ...
        fix: '請將 Printbuddy 切換到外部 PostgreSQL 資料庫。參見文件中的 PostgreSQL 指南。',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        title: '服務正在執行',
        fail: '虛擬印表機已啟用，但其服務未執行。請檢查 Printbuddy 記錄 — 通常是繫結 IP 衝突或權限錯誤使其停止。',
      },
      bind_interface: {
        title: '繫結網路介面',
      ...
      certificate: {
        title: 'TLS 憑證',
        pass: '憑證已就緒。請確保已將 Printbuddy CA 憑證（上方）匯入切片軟體的信任庫。',
        fail: '此虛擬印表機的 TLS 憑證遺失。請檢查 Printbuddy 資料目錄是否可寫入。',
      },
    },
  },
  ...
  bugReport: {
    ...
    submittingStepSubmit: '正在準備 GitHub Issue 連結',
    ...
    submitted: '您的錯誤報告已提交。',
    prepared: '錯誤報告已準備好',
    preparedMessage: '請檢查已準備好的 GitHub Issue，然後手動提交。',
  ...
  failureDetection: {
    ...
    externalUrlHint: 'ML API 透過 URL 擷取攝影機快照。請在一般設定中設定外部 URL，讓 ML API 容器可以連線到 Printbuddy。',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: '貼上 MakerWorld 模型連結，即可直接在 Printbuddy 中匯入並列印 —— 無需切換至 Bambu Handy 應用程式。',
    ...
    importDefaults: '匯入預設值',
    importDefaultsDescription: '自動將這些選擇套用到新的 MakerWorld 匯入。您仍可針對每次匯入覆寫。',
    archiveDetailsByDefault: '預設封存 MakerWorld 詳情',
    archiveDetailsByDefaultDescription: '在本機儲存模型說明、指示和展示圖片。',
    useCoverAsThumbnailByDefault: '預設使用封存的封面作為媒體庫縮圖',
    useCoverAsThumbnailByDefaultDescription: '也會啟用詳情封存，因為縮圖使用本機封存的封面。',
    importDefaultsSaved: 'MakerWorld 匯入預設值已儲存。',
    importDefaultsSaveFailed: '無法儲存 MakerWorld 匯入預設值。',
    archiveDetailsDefaultControl: '預設封存 MakerWorld 詳情',
    coverThumbnailDefaultControl: '預設使用封存的封面作為媒體庫縮圖',
    ...
    disclaimer: 'MakerWorld 整合使用由社群記錄的 API 介面。Printbuddy 與 MakerWorld 或 Bambu Lab 無從屬或認可關係。',
  ...
  libraryPurge: {
    ...
    effect4: '外部（連結）資料夾中的檔案將被略過 — Printbuddy 從不刪除不屬於自己的位元組。',    previewLoading: '正在檢查符合的檔案數量…',
